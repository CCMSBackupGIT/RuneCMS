...
/*
 ...
 +
 +
 + [ @ ] Rune Content Management System :: Architect Application
 +
 +
 +
 ================================================================
...
<HTML>
	<HEAD>
		<TITLE>Rune Content Management System - Architect => Installation Process</TITLE>
...
echo ("
		<HR><CENTER><BIG><B>[ <A HREF=\"https://www.SourceForge.net/projects/RuneCMS/files/Documentation/\" TARGET=\"_NEW\" TITLE=\":: Read The Rune Content Management System Architect Installation Documentation ::\">Architect Installation Documentation</A> ]</B></BIG></CENTER><HR>
		<BR>
		...
		* <I>Secure Uniform Resource Locator With Path-To-RuneCMS Directory</I>:<BR>
		[ General Secure Uniform Resource Location, Example: https://TinkeSoftware.com/RuneCMS ]<BR>
			<INPUT TYPE=\"TEXT\" NAME=\"post_url_secure\"><BR>
		[ Secure Sockets Layer ( S.S.L. ) Uniform Resource Location, Example: https://SSL.TinkeSoftware.com/RuneCMS ]<BR>
			<INPUT TYPE=\"TEXT\" NAME=\"post_url_secure_ssl\"><BR>
		[ Open Secure Sockets Layer ( OpenS.S.L. ) Uniform Resource Location, Example: https://OpenSSL.TinkeSoftware.com/RuneCMS ]<BR>
			<INPUT TYPE=\"TEXT\" NAME=\"post_url_secure_openssl\"><BR>
		[ Transport Layer Security Uniform Resource Location, Example: https://TLS.TinkeSoftware.com/RuneCMS ]<BR>
			<INPUT TYPE=\"TEXT\" NAME=\"post_url_secure_tls\"><BR>
		* <I>Clear-Text Uniform Resource Locator With Path-To-RuneCMS Directory</I>:<BR>
		[ Example: http://TinkeSoftware.com/RuneCMS ]<BR>
		...
		* <I>Current Global System Database Server Class File</I>:<BR>
		...
		[&nbsp;!&nbsp;]&nbsp;*Nix Server Users ( Linux, Unix, B.S.D., G.N.U., etc. ): Please refer to the RuneCMS Architect Installation Manual for a complete list of permissions that should be applied to each individual file.<BR><BR>
		...
		[&nbsp;!&nbsp;]&nbsp;Microsoft Windows Server Users: All of RuneCMS' Files are set to the 'Read Only' flag by default. In order to install RuneCMS correctly you must remove the 'Read Only' flag on each file listed in the Architect Installation Walkthrough.<BR>
		...
		[&nbsp;!&nbsp;]&nbsp;Rune Content Management Systems' programming code has been tested manually as well as by vulnerability and exploit scanning software<BR>
		...
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;It is up to the Administrator of this Web Server that is running Rune Content Management System to install Rune correctly by following each of the important steps stated above,<BR>
		...
		[&nbsp;!&nbsp;]&nbsp;This Installation Application has not been secured from vulnerabilities. Do not leave this Installation Web Application on a live server for longer than is needed to install Rune Content Management System.<BR><BR>
		...
		<B>Rune Content Management System Information:</B><BR>
		=>&nbsp;<A HREF=\"?InternalApplication&#61;Rune_Information\" TITLE=\":: View Detailed Information About What Rune Content Management System Version Is Currently Running On This Web Server ::\">Information About What RuneCMS Version Is Currently Running On This Web Server</A><BR><BR>
		...
		=>&nbsp;<A HREF=\"File-List.txt\" TITLE=\":: Open & Display The File List Document - This Document Was Hand Written By The Programmers of Rune, It Shows Detailed File and Directory Listings, Progress Reports On Files Within The Default Rune Releases ::\">File List</A><BR>
...
mysql_query("INSERT INTO {$_ACCESS_DATABASE_SERVER_DATABASE_TABLE_PREFIX}_application_panels(panel_file_name,panel_alignment,panel_row,panel_file_status,panel_title)VALUES('Rune_Badges','1','1','1','<CENTER><B>Rune Badges</B></CENTER><HR>')");
...
mysql_query("INSERT INTO {$_ACCESS_DATABASE_SERVER_DATABASE_TABLE_PREFIX}_application_panels(panel_file_name,panel_alignment,panel_row,panel_file_status,panel_title)VALUES('RSS_Panel','1','4','1','<CENTER><B>Real-Simple-Syndication</B></CENTER><HR>')");
	...
	echo ("<FONT COLOR=\"#CD0000\">[&nbsp;*&nbsp;]</FONT> Installing Specified Administrator Account Details and Services Root Administrator Account ( Rune )... Please Wait.<BR>");
...
'https://www.Twitter.com/RuneCMS',
'$_POST_ADMINISTRATOR_USERNAME')");

/*
 ================================================================
 + Install RuneCMS Services Root Administrator Account Details
 + ( Rune ) With Specified Administration Account Password
 ================================================================
*/
...
'10000',
'$_POST_ADMINISTRATOR_PASSWORD_3',
'I am Woden ! I am the Services Root Administrator.',
...
copy("./System/Default/Friend/Friend.rune","./Member/$_POST_ADMINISTRATOR_USERNAME/Files/Document/Electronic_Mail/$_POST_ADMINISTRATOR_ELECTRONIC_MAIL_ADDRESS");
...
copy("./System/Default/Friend/Friend.rune","./Member/Master_List/Electronic_Mail_Addresses/$_POST_ADMINISTRATOR_ELECTRONIC_MAIL_ADDRESS");

	echo ("[ Done ]<BR>");

	echo ("<FONT COLOR=\"#CD0000\">[&nbsp;*&nbsp;]</FONT> Installing Services Root Administrator Account ( Woden ) Directory Structure Clone... Please Wait.<BR>");

/*
 ================================================================
 + Make and Create Backup Administrator Directory ( Woden ) and Files
 ================================================================
*/

/*
 + Make Directory: Backup Services-Root Administrator Account ( Woden )
*/

mkdir("./Member/Woden");

/*
 + Make Directory: Backup Services-Root Administrator Account ( Woden ) Organized File Directory Structure
*/

mkdir("./Member/Woden/Files");
mkdir("./Member/Woden/Files/Audio");

mkdir("./Member/Woden/Files/Document");
mkdir("./Member/Woden/Files/Document/Activity_Logging");
mkdir("./Member/Woden/Files/Document/Electronic_Mail");
mkdir("./Member/Woden/Files/Document/Friends");
mkdir("./Member/Woden/Files/Document/Streams");
mkdir("./Member/Woden/Files/Document/Streams/Wall");

mkdir("./Member/Woden/Files/Image");
mkdir("./Member/Woden/Files/Image/Profile");

mkdir("./Member/Woden/Files/Video");

/*
 + Directory Security: Copy Directory Denial Index Files
*/

copy("./Member/Setup/Indexes/Files/Files.php","./Member/Woden/Files/index.php");

copy("./Member/Setup/Indexes/Files/Audio/Audio.php","./Member/Woden/Files/Audio/index.php");

copy("./Member/Setup/Indexes/Files/Document/Document.php","./Member/Woden/Files/Document/index.php");
copy("./Member/Setup/Indexes/Files/Document/Activity_Logging/Activity_Logging.php","./Member/Woden/Files/Document/Activity_Logging/index.php");
copy("./System/Default/Friend/Friend.rune","./Member/Woden/Files/Document/Activity_Logging/Activity_Log.php");
copy("./Member/Setup/Indexes/Files/Document/Electronic_Mail/Electronic_Mail.php","./Member/Woden/Files/Document/Electronic_Mail/index.php");
copy("./Member/Setup/Indexes/Files/Document/Friends/Friends.php","./Member/Woden/Files/Document/Friends/index.php");
copy("./Member/Setup/Indexes/Files/Document/Streams/Streams.php","./Member/Woden/Files/Document/Streams/index.php");
copy("./Member/Setup/Indexes/Files/Document/Streams/Wall/Wall.php","./Member/Woden/Files/Document/Streams/Wall/index.php");

copy("./Member/Setup/Indexes/Files/Image/Image.php","./Member/Woden/Files/Image/index.php");
copy("./Member/Setup/Indexes/Files/Image/Profile/Profile.php","./Member/Woden/Files/Image/Profile/index.php");

copy("./Member/Setup/Indexes/Files/Video/Video.php","./Member/Woden/Files/Video/index.php");

/*
 + Make Directory: Backup Services-Root Administrator Account ( Woden ) Hyper-Text-Markup-Language Web-Page Index File
*/

copy("./System/Default/Register/Register.html","./Member/Woden/index.html");

/*
 + Copy Default Files To Organized Directory Structure: Administrator Electronic Mail Address
*/

copy("./System/Default/Friend/Friend.rune","./Member/Woden/Files/Document/Electronic_Mail/Woden@Localhost");

/*
 + Copy Administrator Electronic Mail Address To Master List
*/

copy("./System/Default/Friend/Friend.rune","./Member/Master_List/Electronic_Mail_Addresses/Woden@Localhost");
...
mysql_query("INSERT INTO {$_ACCESS_DATABASE_SERVER_DATABASE_TABLE_PREFIX}_applications_custom(custom_application_data,custom_application_name,custom_application_time)VALUES('Hello and welcome to Rune Content Management System ! If you\'re reading this then Rune was successfully installed to this web server !','Welcome To Rune','$_GLOBAL_LOCAL_SERVER_DATE')");
...
mysql_query("INSERT INTO {$_ACCESS_DATABASE_SERVER_DATABASE_TABLE_PREFIX}_settings(settings_safeHTML_directory,settings_safeHTML_status,settings_cookie_time,settings_gzip_status,settings_image_extension,settings_language_directory,settings_offline_status,settings_site_title,settings_smileys_directory,settings_sound_extension,settings_theme_directory,settings_upload_size_private,settings_upload_size_public,settings_text_editor_directory)VALUES('Default','1','86400','1','png','English','0','Rune Content Management System','Default','mp3','2022_TinkeSoftware_Grey','256000','10240000','Default')");
...
mysql_query("INSERT INTO {$_ACCESS_DATABASE_SERVER_DATABASE_TABLE_PREFIX}_articles(article_author,article_data,article_time,article_title)VALUES('Rune','This is an Example Article Entry -- You can Delete this Article Entry from the Administration Control Panel.','$_GLOBAL_LOCAL_SERVER_DATE','Example Article')");
...
mysql_query("INSERT INTO {$_ACCESS_DATABASE_SERVER_DATABASE_TABLE_PREFIX}_news(news_author,news_avatar,news_data,news_mood,news_music,news_rss_rfc,news_time,news_title)VALUES('Rune','Default.png','This is an Example News Article Entry -- You can Delete this News Article Entry from the Administration Control Panel.','None','None','Wed, 05 Aug 2009 15:04:18 -0700','$_GLOBAL_LOCAL_SERVER_DATE','Example News')");
	...
	echo ("<FONT COLOR=\"#CD0000\">***</FONT> Woden: Error: I am not able to connect to the Database.<BR>");
	...
	echo ("<FONT COLOR=\"#CD0000\">***</FONT> Woden: Error: the Password(s) that you have provided me do not match each-other. Try Again ?<BR>");
...
if (unlink("./Architect/MySQL/MySQL_Generator.php") && unlink("./Architect/MySQL/index.php") && unlink("./Architect/index.php") && unlink("./Architect/ToolKit/index.php") && unlink("./Architect/ToolKit/Installation_ToolKit.php")) {
	...
	echo ("<FONT COLOR=\"#CD0000\">***</FONT> Woden: Error, I was not able to Secure-Delete the Files: <I>'./Architect/MySQL/MySQL_Generator.php', './Architect/MySQL/index.php', './Architect/ToolKit/index.php', './Architect/ToolKit/Installation_ToolKit.php'</I> Please manually Secure-Delete this File before proceeding.<BR>");
...
if (rmdir("./Architect/MySQL/") && rmdir("./Architect/ToolKit/")) {
	...
	echo ("<FONT COLOR=\"#CD0000\">***</FONT> Woden: Error, I was not able to Remove the Directory: './Architect/MySQL/' or './Architect/ToolKit/' Please manually Remove this Directory before proceeding.<BR>");
...
if (rmdir("./Architect/")) {
	...
	echo ("<FONT COLOR=\"#CD0000\">***</FONT> Woden: Error: I was not able to Remove the Directory: './Architect/' Please manually Remove this Directory before proceeding.<BR>");
...
if (unlink("./Architect.php")) {
	...
	echo ("<FONT COLOR=\"#CD0000\">[&nbsp;*&nbsp;]</FONT> Redirecting To This <B>Rune Content Management System Installation</B> Login Page... Please Wait 15 Seconds.<BR><BR>");

	echo ("<META HTTP-EQUIV=Refresh CONTENT=\"15; URL=Rune.php?Application_Member=Login\">");

} else {

	echo ("<BIG><FONT COLOR=\"#CD0000\">***</FONT> Woden: Error: I was not able to Secure-Delete the File: 'Architect.php' Please manually Secure-Delete this File before proceeding.</BIG><BR>");

} // [ + ] IF: Delete Architect Installation Files

	echo ("<BIG><FONT COLOR=\"#CD0000\">***</FONT> Woden: I am Testing the PHP mail() Function. Please wait...</BIG><BR>");

if (mail($_ACCESS_SYSTEM_ELECTRONIC_MAIL_ADDRESS,"Rune Content Management System - Testing mail() Function.","
-------This is a test to see if the Web Server Post-HyperText-Pre-Processor mail() Function is working-------

-------------------------------------------------------
If you have receieved this Electronic Mail Message Rune Content Management System was installed successfully to your web server.
The only thing left to do now is to manually configure this installation of Rune Content Management System.
-------------------------------------------------------
...
")) {
	...
	echo ("<BIG><FONT COLOR=\"#CD0000\">***</FONT> Woden: I have Tested the PHP mail() Function and it seems to be working.</BIG><BR>");

} else {

	echo ("<BIG><FONT COLOR=\"#CD0000\">***</FONT> Woden: Error: the PHP mail() Function is not working. Correct this before using Rune Content Management System.</BIG>");
...
*/
 ...
 /*
 ================================================================
 + Internal Application: Rune Content Management System Information
 ================================================================
*/

if ($_GET["InternalApplication"] == "RuneCMS_Information") {

echo ("
		<HR><CENTER>Rune Content Management System Information</CENTER><HR>
		<B>Rune Software Project Version Information</B><BR>
		*&nbsp;Extended Version: <I>$_PROJECT_VERSION_EXTENDED</I><BR>
		*&nbsp;Short Version: <I>$_PROJECT_VERSION_SHORT</I><BR><BR>

		<B>Official Rune Software Project Web Servers</B><BR><BR>
		...
		*&nbsp;Data Validation Secure Server: <I>$_PROJECT_SERVER_URL_SECURE/RuneCMS</I><BR>
		*&nbsp;Data Validation Clear-Text Server: <I>$_PROJECT_SERVER_URL_CLEARTEXT/RuneCMS</I><BR><BR>
...
} // [ + ] IF: Internal Application: RuneCMS_Information Is Activated
...
/*
 ================================================================
 + Internal Application: Server Software Information
 ================================================================
*/
...
*/
	...
	echo ("<HR><CENTER>Copyright <BIG><B>&copy;</B></BIG> <A HREF=\"https://www.GitHub.com/TinkeSoftware\" TARGET=\"_NEW\" TITLE=\"Tinke Software On :: GitHub\">Tinke Software</A>, <A HREF=\"https://www.SourceForge.net/projects/runecms\" TITLE=\":: Rune Content Management System Project On :: SourceForge ::\">Rune Content Management System</A>, <A HREF=\"mailto:GCJohnsonChevalier@Protonmail.com\" TITLE=\":: Send Electronic Mail Message To :: GCJohnsonChevalier@Protonmail.com ::\">Gary Christopher Johnson</A>, 2005 - 2023.</CENTER><HR></TD></TR></TABLE>
	</BODY>
</HTML>
");
?>